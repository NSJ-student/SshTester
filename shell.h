...
signals:
    void connected();
    void readyShellMessage(const QString &message);
    void readyRemoteOutput(const QString &output);
    void readyRemoteError(const QString &error);

public slots:
    void onLocalMessage(const QString &message);
